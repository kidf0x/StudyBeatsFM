...
function App() {
  ...
  const [currentLivestream, setLivestream] = useState(
    "https://www.youtube.com/watch?v=pi7D2gYYG00&t=1s"
  );

  const [stationName, setStationName] = useState("Hise & Danh");
  ...
  const [video, setVideo] = useState(
    `//www.youtube.com/embed/8qMY7udUd0U?autoplay=1&mute=1&start=1`
  );

  // <------------- Radio Change section -------------->

  const LofiGirlVideo = () => {
    setVideo("//www.youtube.com/embed/8qMY7udUd0U?autoplay=1&mute=1&start=1");
    setStationName("Lofi Love");
    setYoutubeChannal(
      "https://www.youtube.com/channel/UC8bPck1yk4qmZ5kaznfmNLw"
    );
    setLivestream(
